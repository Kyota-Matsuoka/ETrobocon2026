...
static STK_T _kernel_stack_TRACER_TASK[COUNT_STK_T(STACK_SIZE)];
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_NULL), (EXINF)(0), (TASK)(tracer_task), INT_PRIORITY(TRACER_PRIORITY), {	(void *)(_kernel_stack_TRACER_TASK), 	((void *)((char *)(_kernel_stack_TRACER_TASK) + (ROUND_STK_T(STACK_SIZE)))), }, }
};

TCB _kernel_tcb_table[TNUM_TSKID];

const ID _kernel_torder_table[TNUM_TSKID] = { 
	PYBRICKS_TASK, APP_INIT_TASK, APP_SYNC_TASK, TSKID_tTask_LogTask_Task, MAIN_TASK, TRACER_TASK
};
...
static void
_kernel_cychdr_CYC_TRACER(EXINF exinf)
{
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	...
	{ (TA_NULL), (intptr_t)(TRACER_TASK), _kernel_cychdr_CYC_TRACER, (10000U), (0) }
};
